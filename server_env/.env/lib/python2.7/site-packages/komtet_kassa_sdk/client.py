...
class Client(object):
    ...
    def __get(self, path):
        ...
        return requests.get(url=url, headers=headers, allow_redirects=True, verify=False)
    ...
    def __put(self, path, data):
        ...
        return requests.put(url=url, headers=headers, data=data, verify=False)
    ...
    def __delete(self, path):
        ...
        return requests.delete(url=url, headers=headers, allow_redirects=True, verify=False)
